...
g++-10 -std=c++17 -fopenmp $(pkg-config --cflags --libs opencv4) -o simulation_exec main.cpp LBM.cpp -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs -lstdc++ -lm
